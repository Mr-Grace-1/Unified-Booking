...
export const staff: Staff[] = [
  { id: 'stf1', name: 'Sarah Chen', email: 'sarah@unifiedbook.com', phone: '+1 415-555-1001', avatar: 'https://api.dicebear.com/7.0/avataaars/svg?seed=Sarah&backgroundColor=b6e3f4', role: 'admin', locationIds: ['loc1', 'loc2'], serviceIds: ['svc1', 'svc2', 'svc3'], color: '#8b5cf6', isActive: true },
  { id: 'stf2', name: 'Marcus Johnson', email: 'marcus@unifiedbook.com', phone: '+1 415-555-1002', avatar: 'https://api.dicebear.com/7.0/avataaars/svg?seed=Marcus&backgroundColor=c0aede', role: 'staff', locationIds: ['loc3'], serviceIds: ['svc4', 'svc5'], color: '#f59e0b', isActive: true },
  { id: 'stf3', name: 'Elena Rodriguez', email: 'elena@unifiedbook.com', phone: '+1 415-555-1003', avatar: 'https://api.dicebear.com/7.0/avataaars/svg?seed=Elena&backgroundColor=d1d4f9', role: 'staff', locationIds: ['loc1', 'loc2'], serviceIds: ['svc1', 'svc6'], color: '#ec4899', isActive: true },
  { id: 'stf4', name: 'David Park', email: 'david@unifiedbook.com', phone: '+1 415-555-1004', avatar: 'https://api.dicebear.com/7.0/avataaars/svg?seed=David&backgroundColor=ffd5dc', role: 'staff', locationIds: ['loc2'], serviceIds: ['svc7', 'svc8'], color: '#10b981', isActive: true },
  { id: 'stf5', name: 'Aisha Williams', email: 'aisha@unifiedbook.com', phone: '+1 415-555-1005', avatar: 'https://api.dicebear.com/7.0/avataaars/svg?seed=Aisha&backgroundColor=c0aede', role: 'manager', locationIds: ['loc4', 'loc5'], serviceIds: ['svc9', 'svc10', 'svc11'], color: '#06b6d4', isActive: true },
  { id: 'stf6', name: 'Tom Baker', email: 'tom@unifiedbook.com', phone: '+1 415-555-1006', avatar: 'https://api.dicebear.com/7.0/avataaars/svg?seed=Tom&backgroundColor=b6e3f4', role: 'staff', locationIds: ['loc3'], serviceIds: ['svc4', 'svc5'], color: '#f97316', isActive: true },
];

export const services: Service[] = [
  { id: 'svc1', name: 'Haircut & Styling', category: 'appointment', description: 'Professional haircut with wash and style', duration: 60, price: 75, deposit: 25, currency: 'USD', staffIds: ['stf1', 'stf3'], locationIds: ['loc1', 'loc2'], bufferTime: 15, icon: 'scissors', color: '#8b5cf6' },
  { id: 'svc2', name: 'Consultation Session', category: 'appointment', description: '1-on-1 business or life coaching', duration: 90, price: 150, deposit: 50, currency: 'USD', staffIds: ['stf1'], locationIds: ['loc1'], bufferTime: 15, icon: 'briefcase', color: '#6366f1' },
  { id: 'svc3', name: 'Therapy Session', category: 'appointment', description: 'Licensed therapy session', duration: 50, price: 120, deposit: 40, currency: 'USD', staffIds: ['stf1'], locationIds: ['loc1', 'loc2'], bufferTime: 10, icon: 'brain', color: '#a855f7' },
  { id: 'svc4', name: 'Home Deep Clean', category: 'field', description: 'Full home deep cleaning service', duration: 240, price: 250, deposit: 75, currency: 'USD', staffIds: ['stf2', 'stf6'], locationIds: ['loc3'], bufferTime: 30, icon: 'sparkles', color: '#f59e0b' },
  { id: 'svc5', name: 'Plumbing Repair', category: 'field', description: 'Emergency or scheduled plumbing', duration: 120, price: 180, deposit: 60, currency: 'USD', staffIds: ['stf2', 'stf6'], locationIds: ['loc3'], bufferTime: 30, icon: 'wrench', color: '#eab308' },
  { id: 'svc6', name: 'Deep Tissue Massage', category: 'appointment', description: '60-min therapeutic massage', duration: 60, price: 110, deposit: 30, currency: 'USD', staffIds: ['stf3'], locationIds: ['loc1', 'loc2'], bufferTime: 15, icon: 'hand', color: '#ec4899' },
  { id: 'svc7', name: 'Yoga Flow Class', category: 'class', description: '60-min group yoga session', duration: 60, price: 25, currency: 'USD', staffIds: ['stf4'], locationIds: ['loc2'], maxCapacity: 20, bufferTime: 15, icon: 'flower2', color: '#10b981' },
  { id: 'svc8', name: 'HIIT Training', category: 'class', description: 'High-intensity interval training', duration: 45, price: 30, currency: 'USD', staffIds: ['stf4'], locationIds: ['loc2'], maxCapacity: 15, bufferTime: 15, icon: 'dumbbell', color: '#14b8a6' },
  { id: 'svc9', name: 'Ocean View Suite', category: 'hospitality', description: 'Luxury suite with ocean view', duration: 1440, price: 350, deposit: 100, currency: 'USD', staffIds: ['stf5'], locationIds: ['loc4'], bufferTime: 120, icon: 'hotel', color: '#06b6d4' },
  { id: 'svc10', name: 'Grand Ballroom', category: 'hospitality', description: 'Event space for up to 300 guests', duration: 360, price: 2500, deposit: 1000, currency: 'USD', staffIds: ['stf5'], locationIds: ['loc5'], bufferTime: 60, icon: 'landmark', color: '#0891b2' },
  { id: 'svc11', name: 'Wine Tasting Tour', category: 'tour', description: '3-hour guided wine country tour', duration: 180, price: 95, currency: 'USD', staffIds: ['stf5'], locationIds: ['loc4'], maxCapacity: 12, bufferTime: 30, icon: 'wine', color: '#7c3aed' },
  { id: 'svc12', name: 'Personal Training', category: 'appointment', description: '1-on-1 fitness training session', duration: 60, price: 85, deposit: 30, currency: 'USD', staffIds: ['stf4'], locationIds: ['loc2'], bufferTime: 15, icon: 'heart-pulse', color: '#059669' },
];
